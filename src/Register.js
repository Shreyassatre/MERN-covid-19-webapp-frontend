...
function Register() {
    ...
    async function save_data(e){
        try{
            ...
            await axios.post(`${process.env.REACT_APP_SERVER_URL}/auth/`, registerData);
            ...
            <div className="row d-flex">
                <div className="col-lg-6 mt-lg-5">
                    <div className="card1 pb-5 mt-5">
                        <div className="row px-3 justify-content-center mt-5 mb-lg-0 mb-5 border-line"> <img src="images/login.png" className="image"/> </div>
                    </div>
                </div>
