...
function Donation() {
    ...
    async function save_data(){
        try{
            ...
            await axios.post(`${process.env.REACT_APP_SERVER_URL}/donation`, feedbackData);
...
        const data = await fetch(`${process.env.REACT_APP_SERVER_URL}/donation`, { method: 'POST' }).then((t) =>
            t.json()
        )
